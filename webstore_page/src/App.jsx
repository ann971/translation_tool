...
export default function App() {
  ...
  return <>
    ...
    <header className="header">
      <div className="header-inner">
        ...
        <div className="header-right">
          ...
          <button className="hbtn" onClick={()=>setDemoOpen(true)}><svg viewBox="0 0 24 24" fill="currentColor"><path d="M4 8h4V4H4v4zm6 12h4v-4h-4v4zm-6 0h4v-4H4v4zm0-6h4v-4H4v4zm6 0h4v-4h-4v4zm6-10v4h4V4h-4zm-6 4h4V4h-4v4zm6 6h4v-4h-4v4zm0 6h4v-4h-4v4z"/></svg></button>
    ...
    {shareOpen && <>
      ...
      <div className="share-modal">
        ...
        <div className="share-icons">
          <a className="share-icon" style={{background:'#0088cc'}} href={`https://t.me/share/url?url=${encodeURIComponent(shareUrl)}&text=${encodeURIComponent('Tooltran')}`} target="_blank" rel="noreferrer" title="Telegram">
            <svg viewBox="0 0 24 24" fill="#fff"><path d="M11.944 0A12 12 0 000 12a12 12 0 0012 12 12 12 0 0012-12A12 12 0 0012 0 12 12 0 0011.944 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 01.171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.479.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/></svg>
          </a>
    ...
    {/* LIGHTBOX */}
    {demoOpen && <>
      <div className="share-overlay" onClick={()=>setDemoOpen(false)}/>
      <div className="share-modal report-modal" style={{maxWidth:640}}>
        <button className="share-close" onClick={()=>setDemoOpen(false)}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/></svg>
        </button>
        <h3 className="share-title">📝 Demo Text</h3>
        <p className="share-subtitle">選取以下文字來測試翻譯功能</p>
